...
public class login {
	...
	public void Appdriverhit() throws InterruptedException {
		...
		driver.get("http://172.16.10.85:8081/StarPGCreditApp/#/login");
	...
	public void afterlogincheckwhethercorrecturl() throws InterruptedException {
		String Expected = "http://172.16.10.85:8081/StarPGCreditApp/#/login"; // deployment code done kishore lead
																				// 05April2022
	...
	public void NavigatetoApplicationfullfillmentoption() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/nav/div[2]/perfect-scrollbar/div/div[1]/div[2]/ul[2]/li/a")));

		// WebElement clickapplicationfullfillment =
		// driver.findElement(By.xpath("/html/body/app-root/app-admin/div/div[2]/div/div/nav/div[2]/perfect-scrollbar/div/div[1]/div[2]/ul[2]/li/a"));
		driver.findElement(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/nav/div[2]/perfect-scrollbar/div/div[1]/div[2]/ul[2]/li/a"))
				.click();
		System.out.println("Successfully clicked the Applicationfullfillmentoption"); // code reworked upto
																						// clickapplicationfullfillment
																						// option
	}
	...
	public void clickApplicationdatacaptureoption() throws InterruptedException {
		...
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/nav/div[2]/perfect-scrollbar/div/div[1]/div[2]/ul[2]/li/ul/li[1]/a/span[2]")));
		driver.findElement(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/nav/div[2]/perfect-scrollbar/div/div[1]/div[2]/ul[2]/li/ul/li[1]/a/span[2]"))
				.click();
		System.out.println("Successfully able to open application data capture option"); // Today worked code
																							// datacapture by kishore
																							// team lead 03/03/2022
		Thread.sleep(1000);
	...
	public void OpenNewApplicationfilldetails() throws InterruptedException {
		...
		actions.moveToElement(NewApplication).moveToElement(driver.findElement(By.xpath("//*[@id='nav-appl-tab']")))
				.build().perform();
		((JavascriptExecutor) driver).executeScript("arguments[0].click()",
				driver.findElement(By.xpath("//*[@id='nav-appl-tab']")));
	...
	public void afteropeningapplicationfillbankdetails() throws InterruptedException {
		...
		Thread.sleep(3000);
		Actions actions = new Actions(driver);
		WebElement fillbankappnumber = driver.findElement(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/div/div/div/div/div/app-application-data/div[2]/div/div/div/div[1]/app-card/div/div/div/form/div[1]/div[1]/input"));
		actions.moveToElement(fillbankappnumber).moveToElement(driver.findElement(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/div/div/div/div/div/app-application-data/div[2]/div/div/div/div[1]/app-card/div/div/div/form/div[1]/div[1]/input")));
		...
		Thread.sleep(1000);
		Select bankproductcode = new Select(driver.findElement(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/div/div/div/div/div/app-application-data/div[2]/div/div/div/div[1]/app-card/div/div/div/form/div[1]/div[4]/select")));
		bankproductcode.selectByVisibleText("Visa Platinum Customer");
		System.out.println("Branch product code is selected Successfully"); // Today done upto Branchcode by kishore
																			// lead 08/03/2022
	}
	...
	public void afteropeningapplicationfillpersonaldetails() throws InterruptedException {
		...
		Thread.sleep(1000);
		WebElement MotherMaidenname = driver.findElement(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/div/div/div/div/div/app-application-data/div[2]/div/div/div/div[1]/app-card/div/div/div/form/div[2]/div[8]/input"));
		MotherMaidenname.sendKeys("Cmdevi");
		Select Selectmartialstatus = new Select(
				driver.findElement(By.xpath("//select[@placeholder='Maritial Status']")));
		...
		Thread.sleep(1000);
		WebElement keyindependencies = driver.findElement(By.xpath(
				"/html/body/app-root/app-admin/div/div[2]/div/div/div/div/div/div/div/app-application-data/div[2]/div/div/div/div[1]/app-card/div/div/div/form/div[2]/div[13]/input"));
		...
		driver.findElement(By.xpath(
				...
				.click();
		System.out.println("finally clicking the save proceed & Personal details completed"); // Completed Personal
																								// details in
																								// Application capture
																								// kishore lead on
																								// march1022
	...
	public void NeedtofillEmploymentdetails() throws InterruptedException {
		...
		Select SelectEmpdetails = new Select(
				driver.findElement(By.xpath("//select[@formcontrolname='employementType']")));
		...
		WebElement Otherincomesalary = driver
				.findElement(By.xpath("//*[contains(@placeholder,'Other Income Salary')]"));
